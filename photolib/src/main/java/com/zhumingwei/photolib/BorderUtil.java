...
class BorderUtil {
  ...
  static List<Border> cutBorder(final Border border, final Line l1, final Line l2, final Line l3,
  ...
  static List<Border> cutBorderCross(final Border border, final Line horizontal,
      final Line vertical) {
    List<Border> list = new ArrayList<>();
  ...
  static Matrix createMatrix(Border border, Drawable drawable, float extraSize) {
    return createMatrix(border, drawable.getIntrinsicWidth(), drawable.getIntrinsicHeight(),
        extraSize);
  }
